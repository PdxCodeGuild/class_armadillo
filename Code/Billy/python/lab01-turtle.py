from turtle import * # imports everything form turtle module

circle(50) # draws circle of radius 50 units, head
right(90) # rotates cursor in place to the right 90 deg relative
forward(50) # moves cursor forward to draw line of length 50 units, upper torso
right(90)
forward(50) # right arm
right(180) # rotates cursor in place to the right 180 deg relative 
forward(100) # moves cursor forward to draw line of length 100 units, left arm
left(180) # rotates cursor in place to the left 180 deg relative
forward(50) # cursor back to torso
left(90) 
forward(100) # lower torso with hips
right(45)
forward(100) # right leg
right(180)
forward(100) # back to hips
right(90)
forward(100) # left leg

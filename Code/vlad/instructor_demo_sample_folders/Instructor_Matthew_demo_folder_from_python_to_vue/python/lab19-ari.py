...
# dangerous - program could crash while reading the file
# and not release the file lock
# file = open('twin_cousins.txt', 'r')
# text = file.read()
# file.close()

# with open('twin_cousins.txt', 'r') as file:
#     text = file.read()
# print(text[:1000])
...
# Using a small portion of the text for testing
...
# ari = int(ari) # round down
# ari = math.floor(ari) # round down
# ari = math.ceil(ari) # round up
if ari < 1:
    ari = 1
elif ari > 14:
    ari = 14

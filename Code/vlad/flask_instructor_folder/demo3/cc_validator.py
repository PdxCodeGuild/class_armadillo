...
# the code below will only run if we run this module directly (python cc_validator.py)
# if we import this module into another module the code below will NOT run
if __name__ == '__main__':
    # credit_card_str = input('enter your credit card: ')
    credit_card_str = '4556737586899855'
    print(credit_card_str)
